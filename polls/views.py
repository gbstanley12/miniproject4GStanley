    ...
    anticipated_movies = [
        {
            ...
            'image': 'marvels.jpg',  # Replace with the actual path
        },
        {
            ...
            'image': 'hungergames.jpg',  # Replace with the actual path
        },
        {
            'title': 'Napoleon',
            ...
            'image': 'napoleon.jpg',  # Replace with the actual path
        },
        {
            'title': 'Wonka',
            ...
            'image': 'wonka.jpg',  # Replace with the actual path
        },
        {
            ...
            'image': 'aquaman.jpg',  # Replace with the actual path
        },
        {
            'title': 'Rebel Moon',
            ...
            'image': 'rebel.jpg',  # Replace with the actual path
        },
        {
            'title': 'Ferrari',
            ...
            'image': 'ferrari.jpg',  # Replace with the actual path
        },
        {
            'title': 'Dune: Part Two',
            ...
            'image': 'dune.jpg',  # Replace with the actual path
        },
        {
            ...
            'image': 'place.jpg',  # Replace with the actual path
        },
    ]
